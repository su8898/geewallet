...
type NodeNOnionIntroductionPoint() =
    ...
    member __.``parse NOnionIntroductionPoint``() =
        ...
        //let inputAddress = sprintf "geewallet+nonion://%s@102.21.54.52:8987?EncryptionKey=userEncryptionKey=&AuthKey=userAuthKey&OnionKey=userOnionKey&Fingerprint=userFingerPrint&MasterPublicKey=userMasterPublicKey" pubkey
        ...
        let nOnionIntroductionPoint = GWallet.Backend.UtxoCoin.Lightning.NodeNOnionIntroductionPoint.Parse Currency.LTC inputAddress
